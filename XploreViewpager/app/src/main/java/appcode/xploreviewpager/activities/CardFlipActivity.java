...
package appcode.xploreviewpager.activities;
...
import appcode.xploreviewpager.GoogleSlider;
...
public class CardFlipActivity extends Activity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == android.R.id.home) {
            ...
            NavUtils.navigateUpTo(this, new Intent(this, GoogleSlider.class));
            return true;
        }
        else if (i == R.id.action_flip) {
            flipCard();
            return true;
        }
